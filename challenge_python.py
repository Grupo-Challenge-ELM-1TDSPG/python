...
def menu_usuario_logado(usuario_logado):
    ...
    while True:
        ...
        print("3. Meus Resultados de Exames")
        print("4. Minhas Receitas Médicas")
        ...
        if opcao_login == '3':  # Meus Resultados
            ...
            while True:
                ...
                print(
                    f"  d. Modo Guia Interativo: [{'DESATIVAR' if modo_guia_interativo_ativo else 'ATIVAR'}] Ajuda visual passo a passo.")
                ...
                if escolha_ajuda == 'a':
                    ...
                    print(
                        "[Assistente Virtual]: Olá! Sou o assistente virtual do HC. Estou aqui para ajudar com perguntas comuns.")
                    ...
                    if "exames" in user_query or "resultados" in user_query:
                        print(
                            "[Assistente Virtual]: Para ver seus exames, vá ao Menu do Usuário e escolha a opção '3. Meus Resultados de Exames'.")
                    elif "senha" in user_query:
                        print(
                            "[Assistente Virtual]: Se esqueceu sua senha, na tela de login principal, deveria haver uma opção 'Esqueci minha senha'.")
                        print(
                            "  (Esta funcionalidade ainda será implementada). Por enquanto, contate o suporte do hospital se não conseguir logar.")
                    elif "teleconsulta" in user_query:
                        print(
                            "[Assistente Virtual]: Para teleconsultas, verifique 'Minhas Agendas' (opção 5) para datas e horários.")
                        print(
                            "  O link de acesso geralmente é enviado perto da data. Veja também a opção '6. Informações sobre Teleconsulta'.")
                    elif user_query == 'sair':
                        print("[Assistente Virtual]: Entendido! Se precisar de mais algo, é só chamar.")
                    else:
                        print(
                            "[Assistente Virtual]: Desculpe, ainda estou aprendendo. Para essa dúvida, sugiro consultar as outras opções de ajuda ou contatar o suporte humano do hospital.")
